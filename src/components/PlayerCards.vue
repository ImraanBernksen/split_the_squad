<template>
  ...
  background-position: center;">
              <div class=CardWrapper>
                ...
                <div class=TopSection>
                  ...
                  <span class="TeamLogo">
                    ...
                    <p class="logo">
                      <img src="https://i.postimg.cc/7YNGn4JB/Group-2-1.png" style="margin-left: -10px;" height="50px"
                        width="auto" />
                    </p>
                  </span>
                </div>
                ...
                <div class=TopSection>
                  ...
                  <span class="TeamLogo">
                    ...
                    <p class="logo-meezaan">
                      <img src="https://i.postimg.cc/TY4NC22R/meezaans-trait-removebg-preview-3.png" height="45px"
                        width="auto" />
                    </p>
                  </span>
                </div>
    ...
    background-position: center;">
        ...
        <div class="col-12 col-sm- col-md-4 col-lg-4">
          <div class=Main>
            <div class=BoxWrapper style="background: linear-gradient(rgba(255, 255, 255, 0.039), rgba(0, 0, 0, 1)), url(https://i.postimg.cc/NMhDdVFr/imo-10.jpg)  ;background-repeat: no-repeat;
    background-size: cover;
    background-position: center;">
              <div class=CardWrapper>
                <div class=WrapperLeftCorner></div>
